          ...
          <div class="card-header success with-border">
            <div class="card card-widget widget-user">
              ...
              >
                ...
                <h5 class="widget-user-desc" v-text="descripcion"></h5>
              </div>
              ...
              <form action method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div v-show="errorDepartment" class="form-group row div-error">
                  <div class="text-center text-error bg-danger">
                    <div v-for="error in errorMostrarMsjDepartment" 
      ...
      >
        <div class="modal-dialog modal-primary modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header header-success">
              <h4 class="modal-title" v-text="tituloModal"></h4>
              <button type="button" class="close btn-danger" @click="cerrarModalDep()" aria-label="Close">
                <span aria-hidden="true">×</span>
              </button>
            </div>
            <div class="modal-body">
                  ...
                  <tbody>
                    <tr v-for="product in arrayProduct" :key="product.id">
                      <td>
                        <button
                          type="button"
                          @click="abrirModalDep('product','actualizar',product)"
                          class="btn btn-warning btn-sm"
                        >
...
export default {
  ...
  methods: {
    ...
    departments() {//Seleccionar departamento de commerce
      let me = this;
      axios
