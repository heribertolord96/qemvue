<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
       ...
       <li class="nav-item">
          <a href="invited.commerces.index" class="nav-link">
       ...
       <li class="nav-item">
        <a href="invited.products.index" class="nav-link">
     ...
     <li class="nav-item">
        <a href="invited.promotions.index" class="nav-link">
     ...
     <li class="nav-item">
     <a href="invited.events.index" class="nav-link">
